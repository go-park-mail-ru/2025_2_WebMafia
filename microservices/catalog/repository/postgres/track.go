...
func (r *Repository) GetTrackByID(ctx context.Context, id uuid.UUID) (*model.Track, error) {
	const op = "repository.GetTrackByID"
	query := `
...
func (r *Repository) GetAllTracks(ctx context.Context, limit, offset uint64) ([]model.Track, error) {
	const op = "repository.GetAllTracks"
	query := `
		SELECT track_id, title, duration_s, file_url, play_count, description, created_at, updated_at
		FROM track
...
func (r *Repository) GetTracksByArtistID(ctx context.Context, artistID uuid.UUID, limit, offset uint64) ([]model.Track, error) {
	const op = "repository.GetTracksByArtistID"
	query := `
...
func (r *Repository) GetTracksByAlbumID(ctx context.Context, albumID uuid.UUID, limit, offset uint64) ([]model.Track, error) {
	const op = "repository.GetTracksByAlbumID"
	query := `
		SELECT t.track_id, t.title, t.duration_s, t.file_url, t.play_count, t.description, t.created_at, t.updated_at
		FROM track t
...
func (r *Repository) GetTracksByGenreID(ctx context.Context, genreID uuid.UUID, limit, offset uint64) ([]model.Track, error) {
	const op = "repository.GetTracksByGenreID"
	query := `
		SELECT t.track_id, t.title, t.duration_s, t.file_url, t.play_count, t.description, t.created_at, t.updated_at
		FROM track t
...
func (r *Repository) SearchTracks(ctx context.Context, query string, limit uint64) ([]dto.TrackSearchResult, error) {
	const op = "repository.SearchTracks"
	...
	results := make([]dto.TrackSearchResult, 0, limit)
	for rows.Next() {
		var searchResult dto.TrackSearchResult
		if err := rows.Scan(
