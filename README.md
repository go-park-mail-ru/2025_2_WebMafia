...
Backend-часть для музыкального сервиса Wave Music. Предоставляет RESTful API, разработанное на Go, обеспечивающее работу с пользователями, треками и плейлистами.
