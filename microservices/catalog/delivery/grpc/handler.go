...
//go:generate mockgen -destination=../../../../mocks/catalog/service/grpc_service_mock.go -package=mock_catalog_service spotify/microservices/catalog/delivery/grpc IService
